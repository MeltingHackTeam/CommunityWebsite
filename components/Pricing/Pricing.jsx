                            ...
                            <div className="fancy-box">
                                <div className="inline-flex align-items-center">
                                    ...
                                    <div className="d-inline-block">
                                        <h6 className="font-small uppercase letter-spacing-1">{item.name}</h6>
                                    </div>
                                </div>
                                <ul className="list-unstyled mt-4">
                                    {item.features.map((feature, index) => (
                                        <li key={index}><i className="bi bi-check pe-2"></i>{feature.name}</li>
                                    ))}
                                </ul>
                                <div className="mt-4">
                                    <div className="d-inline-block">
                                ...
                                <Link className="button button-font-2 mt-4" href={item.makeOrderUrl}>Make Order</Link>
                            </div>
                        </div>
                    ))}
                </div> {/* end row */}
