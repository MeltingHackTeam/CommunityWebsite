...
import SmallImage1 from '@/public/images/events/event250823_small1.webp'
import SmallImage2 from '@/public/images/events/event250823_small2.webp'
import SmallImage3 from '@/public/images/events/event250823_small3.webp'
import BigImage1 from '@/public/images/events/event250823_big1.webp'
import BigImage2 from '@/public/images/events/event250823_big2.webp'
                        ...
                        <div className="row mt-5">
                            <div className="col-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
                                ...
                                <div className="py-3">
                                    ...
                                    <ul>
                                        <li>An app for <strong>language learning through karaoke</strong>, displaying lyrics for study.</li>
                                        <li>A <strong>bonsai simulation app</strong> allowing users to virtually try out bonsai in their rooms and purchase them within the app.</li>
                                        <li>A <strong>gamified task management app</strong> designed to help users establish daily habits.</li>
                                        <li>A <strong>voice-activated medical concierge app</strong> for consulting on health issues and receiving advice.</li>
                                        <li>Apps aimed at <strong>sustaining training and workout routines</strong>.</li>
                                    </ul>
                                    <p>These services were so compelling that many felt they would willingly pay to use them. The workshop, refined by MeltingHack&#39;s experience, successfully captivated attendees, making them believe that even beginners could develop an app. Feedback like, <strong>&quot;I wish I had known this Vibe Coding method sooner!&quot;</strong> highlighted the impact of the shared techniques. The participants&#39; engagement was palpable, with many leaning into the presentation screens, eager to absorb every piece of information.</p>
                                </div>
                                <div className="py-3">
                                    <h4>Conclusion</h4>
