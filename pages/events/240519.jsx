...
import SmallImage1 from '@/public/images/events/event240519_small1.webp'
import SmallImage2 from '@/public/images/events/event240519_small2.webp'
import SmallImage3 from '@/public/images/events/event240519_small3.webp'
import BigImage1 from '@/public/images/events/event240519_big1.webp'
import BigImage2 from '@/public/images/events/event240519_big2.webp'
...
const Event240519 = ({ post }) => {
    ...
    return (
        <>
            <Head>
                <title>AR 1Day Hackathon with Apple and Mercari</title>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
                                <h1 className="display-4 fw-normal">AR 1Day Hackathon with Apple and Mercari</h1>
