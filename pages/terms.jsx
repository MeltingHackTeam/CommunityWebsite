...
const termsContent = {
    ja: {
        ...
        sections: [
            {
                content: '提出された申し込みフォームおよび各種資料などは返却いたしかねます。事前に各社内において許可・内諾を得た上でエントリーしてください。'
            },
            {
            ...
            {
                content: '反社会的勢力と関わりのある企業・団体によるエントリーは受付できません。本ハッカソンの受賞後、反社会的勢力との関係が明らかとなった場合には、表彰を取り消す場合がございます。'
            },
            {
                content: '提出されたエントリー情報に関する知的財産権は各企業・団体に帰属します。著作権や肖像権などに関する必要な権利処理は、各企業・団体の責任にてご対応ください。なお、主催者・共催者は、本ハッカソンにおける審査・運営のため必要な範囲において、エントリー情報や各種資料を無償で利用できるものとします。'
            },
            {
                content: '本ハッカソンにて受賞した企業・団体のエントリー情報や各種資料、プレゼン時の映像・写真・音声などは、主催者・共催者の各種広報活動（公式Webサイト、SNS、プレスリリースなど）および各種メディア（テレビ、新聞、雑誌、Webなど）、各種イベントにおいて紹介・掲載させていただく場合がございます。その際は、内容の本質を損なわない範囲で編集・加工を行う可能性があります。'
            }
        ]
    },
    en: {
        ...
        sections: [
            {
                content: 'Submitted application forms and materials will not be returned. Please ensure you obtain prior permission or internal approval within your respective company before submitting your entry.'
            },
            {
            ...
            {
                content: 'We reserve the right to revoke a hackathon recognition if the entry information is found to be false or if it is determined that the entry may infringe upon the rights of a third party.'
            },
            {
                content: 'Entries from companies or organizations associated with anti-social forces will not be accepted. Should a relationship with anti-social forces become evident after the hackathon, the recognition may be revoked.'
            },
            {
                content: 'Intellectual property rights regarding the submitted entry information belong to the respective company or organization. Each company or organization is responsible for securing the necessary rights clearances concerning copyrights, portrait rights, and other intellectual properties. However, the Organizers and Co-Organizers shall be entitled to utilize the entry information and materials without compensation, to the extent necessary for the screening and operation of this hackathon.'
            },
            {
                content: 'The entry information, materials, and presentation video footage, photographs, and audio of the hackathon-winning companies or organizations may be featured or published in the public relations activities of the Organizers and Co-Organizers (e.g., official website, social media, press releases) and in various media (e.g., TV, newspapers, magazines, web) and events. In such cases, the content may be edited or processed, provided that the essential nature of the information is not compromised.'
            }
        ]
    }
}
