                                ...
                                <div className="fancy-box">
                                    ...
                                    <ul className="list-inline-dot">
                                        {post.categories.map((category, index) => (
                                            <li key={index}><Link className="link-hover" href={category.url}>{category.name}</Link></li>
                                        ))}
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div className="fancy-box">
                                    ...
                                    <ul className="list-inline-lg">
                                        {post.tags.map((tag, index) => (
                                            <li key={index}><Link className="link-hover" href={tag.url}>{tag.name}</Link></li>
                                        ))}
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div className="row g-4">
                            {post.media.map((item, index) => (
                                <div key={index} className="col-12 col-lg-4">
                                    <Image className="border-radius-1" src={item.image} alt={item.alt} placeholder="blur" />
                                </div>
                            ))}
                        </div> {/* end row */}
                        ...
                        <div className="row g-4 mt-4">
                            ...
                            {post.images.map((item, index) => (
                                <div key={index} className="col-12 col-md-6">
                                    <div className="lightbox-image" onClick={() => openLightbox(item.image)}>
