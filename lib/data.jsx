...
const themes = {
    ...
    pageAboutUsLight: { title: 'About us | Light', description: '', keywords: '' },
    ...
    pageServicesLight: { title: 'Services | Light', description: '', keywords: '' },
    pageTeamDark: { title: 'Team | Dark', description: '', keywords: '' },
    pageTeamLight: { title: 'Team | Light', description: '', keywords: '' },
    pageBlogListFullWidthDark: { title: 'Blog Posts Fullwidth | Dark', description: '', keywords: '' },
    pageBlogListFullWidthLight: { title: 'Blog Posts Fullwidth | Light', description: '', keywords: '' },
    pageBlogListSidebarDark: { title: 'Blog Posts with Sidebar | Dark', description: '', keywords: '' },
    pageBlogListSidebarLight: { title: 'Blog Posts with Sidebar | Light', description: '', keywords: '' },
    pagePortfolioListDark: { title: 'Portfolio List | Dark', description: '', keywords: '' },
    pagePortfolioListLight: { title: 'Portfolio List | Light', description: '', keywords: '' },
};

export const mainData = {
    websiteTitle: 'MeltingHack',
    description: 'A network of hackathon enthusiasts dedicated to extracting and disseminating valuable lessons',
    keywords: 'melting, hackathon, international, global, tokyo',
    favicon: Favicon,
    ...Object.fromEntries(
